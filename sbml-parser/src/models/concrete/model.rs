...
pub struct ListOfFunctionDefinitions {
    #[serde(rename = "@functionDefinitions", skip_serializing_if = "Option::is_none")]
    function_definitions: Option<Vec<FunctionDefinition>>,
}
#[derive(Deserialize, Serialize, PartialEq, Debug, Clone)]
pub struct ListOfUnitDefinitions {
    #[serde(rename = "@unitDefinitions", skip_serializing_if = "Option::is_none")]
    unit_definitions: Option<Vec<UnitDefinition>>,
}
#[derive(Deserialize, Serialize, PartialEq, Debug, Clone)]
pub struct ListOfCompartments {
    #[serde(rename = "@compartments", skip_serializing_if = "Option::is_none")]
...
pub struct ListOfInitialAssignments {
    #[serde(rename = "@initialAssignments", skip_serializing_if = "Option::is_none")]
